  ...
  a.luck = {
    ...
    alert:function(opt) {
      a.luck.open({
        ...
        content:'<div class="luck-move luck-dialog luck-ico-' + (opt.ico ? opt.ico :0) + '"><i class="luck-ico"></i>' + opt.content + "</div></div>",
        cloBtn:false,
        yes:function(obj) {
          if(opt.callback){
            opt.callback();
    ...
    confirm:function(opt) {
      a.luck.open({
        cloBtn:false,
        content:'<span class="luck-move luck-dialog luck-ico-3"><i class="luck-ico"></i>' + opt.content + "</span>",
        btn:opt.btn?opt.btn:'',
        yes:function(obj) {
